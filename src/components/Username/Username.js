...
export default function Username({userError,handleChangeUsername,submitUsername}) {
    ...
    return (
        <Grid container className={classes.root}>
           ...
           {userError === '' ? <TextField onChange={handleChangeUsername} className={classes.text2} id="standard-basic" label="Write A Name" />:
            <TextField onChange={handleChangeUsername}  style={{color:'red'}} className={classes.text2} id="standard-basic" label="Please You Need Write Name" />}
                <Button
                    color="primary"
